...
const Footer = () => {
  ...
  const headingClasses =
    " font-semibold text-gray-900 mb-4 tracking-wider uppercase";
        ...
        <div className="grid grid-cols-2 gap-y-10 md:grid-cols-4 md:gap-x-12 lg:gap-x-20">
          ...
          <div className="col-span-2 md:col-span-1 pr-6">
            ...
            <p className={`text-gray-600 mb-4`} style={{ lineHeight: "1.6" }}>
              Your premier platform for discovering and booking the perfect
              venue for any event, from tech summits to music showcases.
            </p>
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center w-full">
                <input
                  ...
                  className={`p-[4.4px] border-[2px] border-gray-300 rounded-l outline-none focus:border-orange-500 w-full`}
                />
                <button
                  className="bg-orange-600 text-white p-2 rounded-r hover:bg-orange-700 transition duration-150"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  to="/create-event"
                  className="flex items-center space-x-1 text-orange-600 hover:text-orange-700 font-bold transition duration-150"
                >
              ...
              <li>
                <Link to="/my-events" className={linkClasses}>
                  Manage My Events
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              ...
              <li className={`flex items-center space-x-2 text-gray-600`}>
                ...
                <a
                  href="mailto:support@venubooking.com"
                  className={linkClasses}
                >
                  support@venubooking.com
                </a>
              </li>
              <li className={`flex items-center space-x-2 text-gray-600`}>
            ...
            <div className="flex space-x-4">
              ...
              <a
                ...
                className="text-gray-500 hover:text-pink-600 transition duration-150"
              >
